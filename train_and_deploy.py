...
def main():
    ...
    # Use defaults if not in GitHub Actions
    ...
    endpoint_name = f"logs-error-endpoint-{pd.Timestamp.now().strftime('%Y%m%d-%H%M%S')}"
    ...
    # Write endpoint name to file for GitHub Actions
